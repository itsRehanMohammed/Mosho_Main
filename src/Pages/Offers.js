...
function Offers() {
  ...
  return (
    <>
      <Navbar />
      <div className="bg-white lg:px-20 px-1 py-12 text-center">
        <h1 className="font-bold lg:text-[60px] px-1 text-[28px] mb-5 capitalize">The Food that makes story</h1>
        <div class="block max-w-sm p-6 bg-white border border-white-200 rounded-lg shadow hover:bg-white-100 dark:bg-white-800 dark:border-white-700 dark:hover:bg-white-700">
          <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-gray">Noteworthy technology acquisitions 2021</h5>
          <p class="font-normal text-gray-400 dark:text-gray-600">Here are the biggest enterprise technology acquisitions of 2021 so far, in reverse chronological order.</p>
        </div>
      </div>
      <div className="lg:px-20 px-1 py-10  ">
        <h1 className="font-bold text-[30px] mb-5 text-center">Disclaimer</h1>
        ...
        <Accordion expanded={expanded === "panel4"} onChange={handleChange("panel4")}>
          <AccordionSummary aria-controls="panel4d-content" id="panel4d-header">
            <Typography>How secure is your information with Domino's?</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <Typography>
              <p className="pb-2">
